            ...
            <template v-if="column.dataIndex === 'CustomerID'">
                <div class="editable-cell">
                    <div v-if="editableData[record.key]" class="editable-cell-input-wrapper">
                        <a-input v-model:value="editableData[record.key].CustomerID" @pressEnter="save(record.key)" />
    ...
    setup() {
        ...
        const handleAdd = () => {
            let newData = {
                ...
                CustomerID: `user${count.value}`,
                FlightID: `user${count.value}@example.com`,
                ReservationDate: `user${count.value}@example.com`,
            ...
            axios.post('http://localhost/databigvue/php/adduser.php', {
                ...
                .then((response) => {
                    ...
                    if (response.data[0].code === 1) {
                        newData.key = response.data[0].data.ReservationID;
