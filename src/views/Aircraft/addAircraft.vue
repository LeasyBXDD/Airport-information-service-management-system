<template>
    ...
    <a-table bordered :data-source="dataSource" :columns="columns">
        <template #bodyCell="{ column, text, record }">
            <template v-if="column.dataIndex === 'AircraftType'">
                <div class="editable-cell">
                    <div v-if="editableData[record.key]" class="editable-cell-input-wrapper">
                        <a-input v-model:value="editableData[record.key].AircraftType" @pressEnter="save(record.key)" />
    ...
    setup() {
        ...
        const handleAdd = () => {
            let newData = {
                ...
                AircraftType: `user${count.value}`,
                NumberOfSeats: `user${count.value}@example.com`,
            };
            ...
            axios.post('http://localhost/databigvue/php/adduser.php', {
                ...
                .then((response) => {
                    ...
                    if (response.data[0].code === 1) {
                        newData.key = response.data[0].data.AircraftID;
